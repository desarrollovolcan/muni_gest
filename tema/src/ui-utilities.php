                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="d-flex flex-column gap-2">
                                        ...
                                        <div class="bg-danger-subtle p-2"><code class="text-danger-emphasis">.bg-danger-subtle</code>
                                        </div>
                        ...
                        <div class="card-body pt-2">
                            ...
                            <div class="d-flex align-items-start flex-wrap gap-2">
                                ...
                                <img src="assets/images/users/avatar-2.jpg" class="avatar-lg rounded-circle"
                                     alt="rounded-circle">
                                <img src="assets/images/small/img-3.jpg" class="img-fluid rounded-pill"
                                     alt="rounded-pill" width="100">
                            </div>
